export const Bio = {
    ...
    github: "https://github.com/prasadasw/",
    resume:
      "https://drive.google.com/file/d/1hUNAoChOREu_qDy2PTnzuIk3hUcutXMn/view?usp=sharing",
    linkedin: "https://www.linkedin.com/in/prasad-aswar-5168a0207/",
    twitter: "https://twitter.prasadaswar",
    insta: "https://www.instagram.com/prasad-aswar/",
    facebook: "https://www.facebook.com/prasad-aswar/",
    Youtube:"https://www.youtube.com/channel/UC2va0f_ebk-ebvOBbz7M3-w",
  };
  ...
  export const experiences = [
    {
      ...
      desc: "During my tenure at BharatGo, I collaborated with cross-functional teams to design and implement visually appealing user interfaces for online stores. My proficiency in React.js enabled me to create responsive and dynamic front-end solutions, significantly improving the overall user experience. I have actively contributed to the development and maintenance of APIs using Node, enhancing the functionality and connectivity of the online store platform. My commitment to quality is reflected in my use of end-to-end testing with Cypress to ensure the robustness of applications.",
      skills: [
        "ReactJS",
        "React Native",
        "NodeJs",
    ...
    },
    {
      ...
      desc: "As a front-end developer Role. I developed web Applications and websites using technology like Html, Css, React Js, js, Php, In an internship, I work with a senior developer and learn how to write code from scratch. In some projects, I also work as a Backend developer. with senior I learn how to manage complex design projects. In the internship, I also get knowledge about Hosting.",
      skills: [
        "ReactJs",
        "JavaScript",
         "HTML",
  ...
  export const education = [
    {
      ...
      grade: "8.38 CGPA",
      desc: "Recently completed my post-graduation in MCA from AIMS.",
      degree: "MCA",
    },
    {
      id: 1,
    ...
    },
    {
      id: 2,
      // img: "https://firebasestorage.googleapis.com/v0/b/flexi-coding.appspot.com/o/methodist.png?alt=media&token=018a1b18-e2dd-4f34-8855-cff1b6b69fd3",
      school: "Adarsh Vidhyalay Chikhli , Buldhana",
      date: "Apr 2018",
      grade: "65.20%",
  ...
  export const projects = [
    {
      ...
      description:
      "Crafted a sleek client portfolio using React.js for dynamic user interfaces, SCSS for stylish and responsive design, and added smooth animations with Framer Motion to enhance the overall user experience.",
      image:
        "C:/Users/ashwi/Documents/Desktop/Myportfolio/PrasadAswar/public/HeroImage.jpg",
      tags: [
        "React Js",
         "scss",
         "Framer Motion."
      ...
      category: "web app",
      github: " https://github.com/Prasadasw/Newportfolio.git",
      webapp: "https://65d33db0d310ec00a2128e2d--thunderous-gumption-8b8bb1.netlify.app/",
    },
    // {
    //   id: 9,
    //   title: "Trackify",
    ...
    // },
    {
      ...
      date: "Feb 2024",
      description:
      "Designed and developed a vibrant Digital Marketing website named 'House Of DM' using HTML, CSS, and JavaScript. The site combines a visually appealing layout with interactive features to showcase services, expertise, and engage visitors, providing a seamless online presence for the client."  ,
        image:
      ...
      category: "web app",
      github: "https://github.com/Prasadasw/digital-marketing-.git",
      webapp: "https://65d33ff3fcec4c056057dbb7--courageous-cranachan-ae7219.netlify.app/",
    },
    // {
    //   id: 2,
    ...
    // },
    {
      ...
      date: "Jun 2023",
      description:
        " A Todo Web App made with React JS and Material UI. It has a login page where users can log . It has a sidebar where users can see all the tasks and can create a new task. It has a calendar where users can see all the tasks on a particular date. It has a search bar where users can search for a particular task.",
      // image:
    ...
    // },
    {
      ...
      "Currently developing an engaging Quiz Application that allows multiple players to participate simultaneously. Introducing the excitement of live contests, the platform provides a dynamic and interactive experience for users to challenge their knowledge, compete in real-time, and enjoy a thrilling gaming atmosphere."   ,
